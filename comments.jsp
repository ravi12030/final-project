...
<
style>
	/* Remove the navbar's default margin-bottom and rounded borders */ .fa
	{
	font-size: 40px;
	padding: 20px;
	border-radius: 50%;
...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<h2 class="text-center">Search Post to view Comments</h2>
			<form action="/app/comments" method="get">
				<div class="form-group">
					<label for="formGroupExampleInput">Post Id</label> <input
						type="text" class="form-control" id="formGroupExampleInput"
						name="postId" placeholder="Enter the postId to search">
				</div>
	...
	<div class="container">
		<div class="jumbotron">
			...
			<div class="comments">
				...
				%>
				<h4>
					User id:<%=comment.getUser_id()%></h4>
				<h6>
					Comment:<%=comment.getComment_body()%></h6>
				...
				<form action="/app/addComment" method="post">
					<div class="form-group">
						...
						<textarea cols="3" class="form-control"
							id="formGroupExampleInput2" name="commentBody"
							placeholder="Enter the body"></textarea>
					</div>
					<button class="btn btn-primary btn-md">Submit</button>
				</form>
				<br>
				<form action="/app/updateComment" method="post">
				<div class="form-group">
						<label for="formGroupExampleInput2">Update Comment</label> <input
							class="form-control" id="formGroupExampleInput2" name="commentId"
							placeholder="Enter the id to be updated">
							<br>
						<textarea cols="3" class="form-control"
							id="formGroupExampleInput2" name="commentBody"
							placeholder="Enter the body"></textarea>
				...
				<form action="/app/deleteComment" method="post">
					<div class="form-group">
						<label for="formGroupExampleInput2">Comment</label> <input
							class="form-control" id="formGroupExampleInput2" name="commentId"
