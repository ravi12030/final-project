...
<body>
  ...
  <div class="container">
		<div class="jumbotron">
			<h2 class="text-center">Share Whats on your mind!</h2>
			<form action="/app/addpost" method="post">
				...
				<div class="form-group">
					...
					<textarea cols="3" class="form-control" id="formGroupExampleInput2" name="postBody"
	 ...
	 <div class="container">
		<div class="jumbotron">
			<h2 class="text-center">Update your Posts!</h2>
			<form action="/app/updatepost" method="post">
			<div class="form-group">
					<label for="formGroupExampleInput">Id</label> <input type="text"
						class="form-control" id="formGroupExampleInput" name="postId"
...
// 		List<Post> list = (List<Post>) request.getAttribute("list");
	...
	postlist = postImpl.viewbyUser(id);
	%>
	<%
